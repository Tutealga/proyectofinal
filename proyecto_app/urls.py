...
from proyecto_app.views import nuevo_descripcion, nuevo_producto, productos, usuarios, descripcion, buscar, nuevo_usuario, nuevo_producto, nuevo_descripcion, Detalle_productos, Borrar_productos, Editar_productos, login_view, logout_view, register_view
